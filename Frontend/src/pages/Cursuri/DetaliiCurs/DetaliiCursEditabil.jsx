...
import './DetaliiCursEditabil.css';
        ...
        <div className="detalii-container">
            ...
            <div className="sectiune">
                ...
                {isEditingDescription ? (
                    <div>
                        ...
                        />
                        <button className="buton-optiune" onClick={saveCourseChanges}>Salvează</button>
                        <button className="buton-optiune" onClick={() => setIsEditingDescription(false)}>Anulează</button>
                    </div>
                ) : (
                    <div>
                        <p>{description || 'Fără descriere'}</p>
                        <button className="buton-optiune" onClick={() => setIsEditingDescription(true)}>Editează</button>
                    </div>
                )}
            </div>
            ...
            <div className="sectiune">
                ...
                {isEditingFormula ? (
                    <div>
                        ...
                        />
                        <button className="buton-optiune" onClick={saveFormula}>Salvează</button>
                        <button className="buton-optiune" onClick={() => setIsEditingFormula(false)}>Anulează</button>
                    </div>
                ) : (
                    <div>
                        ...
                        <button className="buton-optiune" onClick={() => setIsEditingFormula(true)}>Editează</button>
                    </div>
                )}
            </div>
            ...
            <div className="sectiune bibliografie">
                ...
                {materials.length > 0 ? (
                    <div>
                        {materials.map((m) => (
                            <div key={m.id} className="bibliografie-material">
                                {renameMaterialId === m.id ? (
                                    <div className="material-rename-container">
                                        <input
                                            type="text"
                                            value={newFilename}
                                        ...
                                        />
                                        <button className="buton-optiune material-rename-button" onClick={saveNewFilename}>Salvează</button>
                                        <button className="buton-optiune material-rename-button" onClick={cancelRename}>Anulează</button>
                                    </div>
                                ) : (
                                    <div className="material-container">
                                        <span className="material-filename">{m.filename}</span>
                                        <div className="material-buttons">
                                            <button className="material-button" onClick={() => downloadMaterial(m.id, m.filename)}>Descarcă</button>
                                            <button className="material-button" onClick={() => startRenameMaterial(m.id, m.filename)}>Redenumește</button>
                                            <button className="buton-optiune material-button" onClick={() => deleteMaterial(m.id)}>Șterge</button>
                                        </div>
                                    </div>
                                )}
                            </div>
