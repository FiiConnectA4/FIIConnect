...
public class CerereAdeverintaStudentDTO {
    private Integer id;
    ...
    public CerereAdeverintaStudentDTO() {}

    public CerereAdeverintaStudentDTO(Integer id, Long studentId, String studentName, String status,
                                      String dataTrimitere, String comentariu, String adresa) {
        this.id = id;
